...
gdjs.StoryCode.asyncCallback16878700 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.StoryCode.asyncCallback16878700(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.StoryCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(16878492);
}
}}
...
gdjs.StoryCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(16813244);
}
}}
}
